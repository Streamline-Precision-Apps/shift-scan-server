                    ...
                    <div className="flex flex-row gap-2 items-center justify-between w-full max-w-[500px] py-1">
                        ...
                        <div className="w-fit ">
                            <Button
                                ...
                                variant={"outline"}
                                onClick={() =>
                                    setShowExportGuide(!showExportGuide)
                                }
                                className={
                                    showExportGuide
                ...
                <div className="flex-1 w-full px-2 pt-2 pb-10 space-y-5 overflow-y-auto no-scrollbar">
                    <div className="w-full">
                        ...
                        <div className="flex flex-col gap-1 pt-4">
                            ...
                            <Input
                                id="exportFileName"
                                placeholder={`timesheets_${new Date()
                                    .toISOString()
                                    .slice(0, 10)}`}
                    ...
                    <div className="w-full flex flex-col items-center mb-2">
                        ...
                        <div className="w-full pt-1 pb-4">
                            <p className="text-xs text-gray-600">
                                Customize your export with additional options to
                                filter, sort, and include specific fields.
                            </p>
                        </div>
                        <Accordion
                            type="single"
                                ...
                                <AccordionTrigger className="py-3 hover:no-underline">
                                    <div className="flex flex-row items-center gap-2 ">
                                        ...
                                        <div className="w-full flex flex-row items-center gap-2">
                                            ...
                                            <p className="text-xs text-gray-600">
                                                Filter the exported data based
                                ...
                                <AccordionContent>
                                    <div className="w-full mb-4">
                                        <div className="w-full bg-slate-50 rounded-lg py-1.5 px-1.5 border border-gray-200 transition-all duration-200 ease-in-out">
                                            {/* User Selection */}
                                            <div
                                                className={`p-2 rounded-md flex flex-col gap-2 mb-4  ${
                                                    selectCrewEnabled
                                                        ? "bg-slate-50 border-gray-200 border"
                                            ...
                                            <div className="bg-white p-2 rounded-md flex flex-col gap-2   border border-gray-200">
                                                ...
                                                <p className="w-full text-xs text-gray-600 mb-2">
                                                    ...
                                                    all times from 12:00 AM to
                                                    11:59 PM. Adjust to narrow
                                                    or expand the range.
                                                </p>
