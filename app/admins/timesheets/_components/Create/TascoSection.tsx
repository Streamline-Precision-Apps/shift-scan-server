            ...
            {isFShift(log) && (
              <div className="mt-4 border-t pt-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-semibold">F-Shift Loads</h4>
                  <Button
                    type="button"
                    variant="outline"
                    size="sm"
                ...
                {log.TascoFLoads && log.TascoFLoads.length > 0 ? (
                    ...
                    {log.TascoFLoads.map((fLoad, fIdx) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          variant="destructive"
                          size="sm"
                          onClick={() => removeTascoFLoad(idx, fIdx)}
                          className="mt-6"
                        >
                  ...
                  <p className="text-xs text-gray-500 italic">
                    No loads added yet. Click &quot;Add Load&quot; to begin.
                  </p>
                )}
              </div>
            )}
