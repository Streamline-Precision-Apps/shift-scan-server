                                ...
                                <div>
                                    ...
                                    {isEditingHigherPermissionUser && (
                                        <p className="text-xs text-orange-600 mb-1">
                                            Cannot modify permission - This user
                                            has a higher access level than yours
                                        </p>
                                    )}
                                    <Select
