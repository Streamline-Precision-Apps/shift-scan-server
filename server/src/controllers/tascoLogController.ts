...
import {
  getTascoLogById,
  getTascoLogsByTimesheet,
  updateTascoLogLoadQuantity,
  updateTascoLogComment,
  createTascoRefuelLog,
  getTascoRefuelLogs,
  updateTascoRefuelLog,
  deleteTascoRefuelLog,
  createTascoFLoad,
  getTascoFLoads,
  updateTascoFLoad,
  deleteTascoFLoad,
  getCompleteTascoLogData,
  deleteTascoLog,
  getActiveTascoLogForUser,
 ...
 */
export async function getTascoLogController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function getTascoLogsByTimesheetController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function updateLoadQuantityController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function updateTascoCommentController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function createRefuelLogController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function getRefuelLogsController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 * Update a Refuel Log
 */
export async function updateRefuelLogController(
  req: Request,
  res: Response
): Promise<void> {
  try {
    ...
    const updatedRefuel = await updateTascoRefuelLog(
      refuelLogId,
      gallonsRefueled,
      milesAtFueling
    );
 ...
 */
export async function createFLoadController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function getFLoadsController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 * Update a TascoFLoad
 */
export async function updateFLoadController(
  req: Request,
  res: Response
): Promise<void> {
  try {
    ...
    const updatedFLoad = await updateTascoFLoad(
      Number(fLoadId),
      weight,
      screenType
    );
 ...
 * Delete a TascoFLoad
 */
export async function deleteFLoadController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function getCompleteTascoLogController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function deleteTascoLogController(
  req: Request,
  res: Response
): Promise<void> {
  try {
 ...
 */
export async function getTascoLogFieldController(
  req: Request,
  res: Response
): Promise<void> {
  try {
    ...
    switch (field.toLowerCase()) {
      case "comment":
        const { getTascoLogComment } = await import(
          "../services/tascoLogService.js"
        );
        data = await getTascoLogComment(id);
        break;

      case "loadcount":
        const { getTascoLogLoadCount } = await import(
          "../services/tascoLogService.js"
        );
      ...
      case "refuellogs":
        const { getTascoLogRefuelLogs } = await import(
          "../services/tascoLogService.js"
        );
      ...
      case "floads":
        const { getTascoLogFLoad } = await import(
          "../services/tascoLogService.js"
        );
 ...
 */
export async function getActiveTascoLogController(
  req: Request,
  res: Response
): Promise<void> {
  try {
