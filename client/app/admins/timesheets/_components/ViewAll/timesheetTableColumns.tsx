            ...
            return (
                <div className=" text-xs text-center">
                    {row.original.endTime
                        ? format(row.original.endTime, "hh:mm a")
                        : ""}
                </div>
            );
        },
                        ...
                        >
                            {parseFloat(hours) > 0.1 ? (
                                <div className="text-xs">
                                    ...
                                    {Math.round((parseFloat(hours) % 1) * 60)}{" "}
                                    minutes
                                </div>
                            ) : (
                                <div className="text-xs text-center">{`Flagged under ${Math.round(
                                    (parseFloat(hours) % 1) * 60
                                )} mins`}</div>
                            )}
                        </TooltipContent>
                    </Tooltip>
                    ...
                    {ChangeLogs > 0 && (
                        <Tooltip>
                            ...
                            <TooltipContent
                                ...
                                className="w-[120px] justify-center"
                            >
                                <div className="text-xs text-center">{`${ChangeLogs} ${
                                    ChangeLogs === 1
                                        ? "change detected"
                                        : "changes detected"
                                }`}</div>
