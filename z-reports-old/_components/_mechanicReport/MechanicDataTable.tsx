...
interface MechanicDataTableProps {
  data: MechanicReportRow[];
  loading: boolean;
}

export function MechanicDataTable({ data, loading }: MechanicDataTableProps) {
            ...
            <Table>
              ...
              <TableBody className="divide-y divide-gray-200 bg-white">
                {table.getRowModel().rows?.length ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={mechanicReportColumns.length}
                      className="h-[73vh] text-center"
                    >
                      No mechanic projects found.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
